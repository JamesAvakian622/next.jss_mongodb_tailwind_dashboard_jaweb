  ...
  return (
    <li className='relative' x-data='{ dropdownOpen: false, notifying: true }'>
      ...
      <div
        ...
        className={`absolute -right-16 z-99999 mt-2.5 flex h-90 w-75 flex-col rounded-sm border border-strokedark bg-boxdark text-white shadow-lg sm:right-0 sm:w-80 [&_a]:!text-white [&_h6]:!text-white [&_p]:!text-white ${
      ...
      >
        ...
        <ul className='flex h-auto flex-col overflow-y-auto'>
          <li>
            <Link
              className='flex gap-4.5 border-t border-strokedark px-4.5 py-3 text-white hover:bg-meta-4'
              to='/messages'
            >
