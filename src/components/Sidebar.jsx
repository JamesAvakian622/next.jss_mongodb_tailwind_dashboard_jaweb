...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  return (
    ...
    >
      {/* <!-- SIDEBAR HEADER --> */}
      <div className="flex items-center justify-between gap-2 px-6 pt-5.5 pb-2 lg:pt-6.5 lg:pb-3">
        <div className="flex min-w-0 flex-1 flex-col items-center gap-1.5 text-center">
          <NavLink to="/" className="inline-block w-full">
            <h1 className="sidebarNav leading-tight text-black dark:text-white">
              <b>James L. Avakian</b>
            </h1>
          </NavLink>
          <a
          ...
          >
            <img
              src={CoolJimmyLogo}
              alt="Cool Jimmy logo"
              className="mx-auto h-24 w-24 rounded-full border-2 border-black/10 object-cover shadow-md ring-2 ring-black/5 dark:border-white/20 dark:ring-white/10"
            />
          </a>
          <a
            href="http://www.CoolJimmy.com"
            target="_blank"
            rel="noopener noreferrer"
            className="text-base font-medium text-black/70 underline-offset-2 hover:text-black hover:underline dark:text-bodydark2 dark:hover:text-white"
          >
            Cool Jimmy
          </a>
        </div>
      ...
      <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        {/* <!-- Sidebar Menu --> */}
        <nav className="mt-1 py-1 px-4 lg:mt-1 lg:px-6">
          <div>
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <NavLink
                  to="/intro"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-body hover:bg-gray-2 dark:text-bodydark1 dark:hover:bg-meta-4 duration-300 ease-in-out ${
                    pathname === "/intro" && "bg-gray-2 dark:bg-meta-4"
                  }`}
                >
                  <svg
                    className="fill-current"
                  ...
                  >
                    <path
                      d="M9 1.5C4.86 1.5 1.5 4.86 1.5 9s3.36 7.5 7.5 7.5 7.5-3.36 7.5-7.5S13.14 1.5 9 1.5Zm0 3.375a1.125 1.125 0 1 1 0 2.25 1.125 1.125 0 0 1 0-2.25Zm1.5 8.25h-3v-.75h.75V8.625H7.5v-.75H10.5v4.5h.75v.75Z"
                      fill=""
                    />
                  </svg>
                  Introduction
              ...
              {/* <!-- Menu Item Dashboard (moved to top of accordions) --> */}
              <SidebarLinkGroup
                activeCondition={
                        ...
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <NavLink
                              to="/"
                              className={({ isActive }) =>
                                "group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-body hover:text-black dark:text-bodydark2 dark:hover:text-white duration-300 ease-in-out " +
              ...
              {/* <!-- JA Site Section: Work --> */}
              <SidebarLinkGroup activeCondition={pathname.startsWith("/site/")}>
                {(handleClick, open) => (
                  <React.Fragment>
                    <button
                      type="button"
                      onClick={handleClick}
                      aria-expanded={open}
                      className="group relative flex w-full items-center justify-between rounded-sm px-4 py-2 text-left text-base font-medium text-body hover:text-black dark:text-bodydark1 dark:hover:text-white"
                    >
                      <span className="flex items-center gap-2">
                        {/* Briefcase icon for Work (outline) */}
                        <svg
                          ...
                          aria-hidden="true"
                        >
                          <path d="M20.25 14.15v4.6a2.25 2.25 0 0 1-2.25 2.25H6a2.25 2.25 0 0 1-2.25-2.25v-4.6m16.5 0a4.5 4.5 0 0 1-1.421.318 48.51 48.51 0 0 1-13.658 0 4.5 4.5 0 0 1-1.421-.318m16.5 0V8.25A2.25 2.25 0 0 0 18 6h-3M3.75 14.15V8.25A2.25 2.25 0 0 1 6 6h3m6 0V4.5a2.25 2.25 0 0 0-2.25-2.25h-1.5A2.25 2.25 0 0 0 9 4.5V6m6 0H9" />
                        </svg>
                        Work
                      </span>
                      <svg
                    ...
                    >
                      {[
                        ...
                        <li key={to}>
                          <NavLink
                            to={to}
                            className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-6 text-base font-medium text-body hover:bg-gray-2 dark:text-bodydark1 dark:hover:bg-meta-4 duration-300 ease-in-out ${
                              pathname === to && "bg-gray-2 dark:bg-meta-4"
                            }`}
                          >
                            {label}
                          </NavLink>
              ...
              <SidebarLinkGroup activeCondition={pathname.startsWith("/site/")}>
                {(handleClick, open) => (
                  <React.Fragment>
                    ...
                    >
                      <span className="flex items-center gap-2">
                        {/* Music note icon for Media (outline) */}
                        <svg
                          className="text-current"
                          width="18"
                          height="18"
                          ...
                          aria-hidden="true"
                        >
                          <path d="M9 9V5.25l11-2.25v3.75M9 9l11-2.25M9 9v9.75M9 18.75A2.25 2.25 0 1 1 6.75 16.5 2.25 2.25 0 0 1 9 18.75Zm11-3.75a2.25 2.25 0 1 1-2.25-2.25A2.25 2.25 0 0 1 20 15Zm0 0V6.75" />
                        </svg>
                        Media
                      </span>
                      <svg
              ...
              <li>
                <NavLink
                  to="/profile"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-body hover:bg-gray-2 dark:text-bodydark1 dark:hover:bg-meta-4 duration-300 ease-in-out ${
                    pathname.includes("profile") && "bg-gray-2 dark:bg-meta-4"
                  }`}
                >
                  <svg
                    className="fill-current"
              ...
              <li>
                <NavLink
                  to="/tables"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-body hover:bg-gray-2 dark:text-bodydark1 dark:hover:bg-meta-4 duration-300 ease-in-out ${
                    pathname.includes("tables") && "bg-gray-2 dark:bg-meta-4"
                  }`}
                >
                  <svg
                    className="fill-current"
          ...
          {/* <!-- Others Group --> */}
          <div>
            <h3 className="mb-4 ml-4 text-sm font-semibold text-black/60 dark:text-bodydark2">
              OTHERS
            </h3>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <NavLink
                  to="/chart"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-body hover:bg-gray-2 dark:text-bodydark1 dark:hover:bg-meta-4 duration-300 ease-in-out ${
                    pathname.includes("chart") && "bg-gray-2 dark:bg-meta-4"
                  }`}
                >
                  <svg
                    className="fill-current"
