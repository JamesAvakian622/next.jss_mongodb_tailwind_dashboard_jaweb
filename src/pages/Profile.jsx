...
import profileCoverBanner from "../images/brand-corvette-banner.png";
  ...
  return (
    <DefaultLayout>
      ...
      <div className="overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="relative z-20 h-44 min-h-[11rem] w-full overflow-hidden md:h-72 lg:h-80">
          <img
            src={profileCoverBanner}
            alt=""
            className="h-full w-full rounded-tl-sm rounded-tr-sm object-cover object-top"
          />
          <div
        ...
        <div className="px-4 pb-8 text-center sm:px-6 lg:pb-10 xl:pb-12">
          <div className="relative z-30 mx-auto -mt-22 flex w-full max-w-2xl justify-center px-2">
            <div className="relative h-30 w-full max-w-30 rounded-full bg-white/25 p-1 shadow-lg ring-2 ring-white/40 backdrop-blur-md dark:bg-black/30 dark:ring-white/20 sm:h-44 sm:max-w-44 sm:p-3">
          ...
          <div className="mt-10 space-y-2 sm:mt-12">
            <h3 className="text-3xl font-semibold tracking-tight text-black dark:text-white sm:text-4xl">
              James L. Avakian
            </h3>
            <p className="text-base font-medium text-body dark:text-bodydark">
              Software Developer
            </p>
            ...
            <div className="mx-auto max-w-180">
              ...
              <p className="mt-4.5 leading-relaxed">
                Experienced ReactJS software developer with full-stack training in
                MERN and CSS3 website database development
              </p>
            </div>
